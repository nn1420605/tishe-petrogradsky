const VERSION='tishe-mobile-v16-water-safe-routes';
const CORE=['./','./index.html','./manifest.webmanifest','./icon.svg','./map-content.js','./tile-meta.json','./compare-routes.css?v=11','./compare-routes.js?v=16','./route-worker.js?v=16','./smooth-desktop.css?v=12b','./smooth-desktop.js?v=12b','./responsive-layout.css?v=13b'];
