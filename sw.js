const VERSION='tishe-mobile-v17b-maps-interface';
const CORE=['./','./index.html','./manifest.webmanifest','./icon.svg','./map-content.js','./tile-meta.json','./compare-routes.css?v=11','./compare-routes.js?v=17b','./route-worker.js?v=16','./smooth-desktop.css?v=12b','./smooth-desktop.js?v=12b','./responsive-layout.css?v=13b','./maps-ui-v17.css?v=17b','./maps-ui-v17.js?v=17b'];
